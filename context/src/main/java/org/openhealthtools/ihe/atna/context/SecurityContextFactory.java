...
/**
 * Factory to create, initialize, and hold in a Thread Local context the singleton
...
public class SecurityContextFactory {
    ...
    private static final ConfigurableInheritableThreadLocal<SecurityContext> SECURITY_CONTEXT_THREAD_LOCAL_INSTANCE =
            new ConfigurableInheritableThreadLocal<SecurityContext>() {
    ...
    /**
     * Aloows threads to clean up their thread-local SecurityContext
     */
    public static void cleanupSecurityContext() {
        SECURITY_CONTEXT_THREAD_LOCAL_INSTANCE.remove();
    }
}
